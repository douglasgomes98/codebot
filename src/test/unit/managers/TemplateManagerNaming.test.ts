...
describe('TemplateManager - New Naming Rules', () => {
  ...
  describe('applyNamingRules with template folder name', () => {
    it('should replace file name starting with template folder name', () => {
      ...
      const applyNamingRules = (templateManager as any).applyNamingRules.bind(templateManager);
      
      const result = applyNamingRules('ComponentSass.stories.tsx', 'Page', 'ComponentSass');
    ...
    it('should replace file name with different component name', () => {
      ...
      const result = applyNamingRules('ComponentSass.module.scss', 'UserProfile', 'ComponentSass');
    ...
    it('should handle case insensitive matching', () => {
      ...
      const result = applyNamingRules('componentsass.test.tsx', 'Page', 'ComponentSass');
    ...
    it('should preserve existing template/Template replacement functionality', () => {
      ...
      const result = applyNamingRules('template.config.js', 'Page', 'ComponentSass');
    ...
    it('should handle both template folder name and template keyword', () => {
      ...
      const result = applyNamingRules('ComponentSass.template.tsx', 'Page', 'ComponentSass');
    ...
    it('should handle empty or undefined template folder name', () => {
      ...
      const result2 = applyNamingRules('ComponentSass.stories.tsx', 'Page', undefined);
  ...
  describe('extractTemplateFolderName', () => {
    it('should extract folder name from Unix path', () => {
      const extractTemplateFolderName = (templateManager as any).extractTemplateFolderName.bind(templateManager);
      
      const result = extractTemplateFolderName('/path/to/templates/ComponentSass');
    ...
    it('should extract folder name from Windows path', () => {
      ...
      const result = extractTemplateFolderName('C:\\templates\\ComponentStyled');
    ...
    it('should handle errors gracefully', () => {
      ...
      const result = extractTemplateFolderName(null);
  ...
  describe('integration with processTemplateHierarchy', () => {
    it('should extract template folder name and pass it through the processing chain', async () => {
      ...
      const templateStructure = await newTemplateManager.scanTemplateStructure('/test/templates/ComponentSass');
      const result = await newTemplateManager.processTemplateHierarchy(templateStructure, 'Page');
