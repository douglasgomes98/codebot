...
jest.mock('../../../helpers', () => ({
  ...
  formatTemplateName: jest.fn((templateFile, templateType, componentName) => {
    return templateFile
      .replace('.hbs', '')
      .replace(templateType, componentName);
  }),
}));
...
jest.mock('../../../managers/FileSystemManager', () => ({
  FileSystemManager: jest.fn().mockImplementation(() => ({
    ...
    listFiles: jest
      .fn()
      .mockResolvedValue(['component.tsx.hbs', 'component.test.tsx.hbs']),
    ...
    listFilesRecursive: jest.fn().mockResolvedValue([
      ...
      {
        name: 'component.test.tsx.hbs',
        path: 'component.test.tsx.hbs',
        isDirectory: false,
      },
    ]),
  })),
    ...
    scanTemplateStructure: jest.fn().mockResolvedValue({
      ...
      files: [
        ...
        },
        {
          name: 'component.test.tsx.hbs',
          path: 'component.test.tsx.hbs',
          relativePath: 'component.test.tsx.hbs',
        },
      ],
      directories: [],
    }),
